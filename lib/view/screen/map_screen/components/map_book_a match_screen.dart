...
import 'package:futsal/view/screen/map_screen/components/map_booking_info_screen.dart';
import 'package:provider/provider.dart';
import 'package:table_calendar/table_calendar.dart';

class MapBooKAMatchScreen extends StatefulWidget {
  MapBooKAMatchScreen({Key? key, required this.model1}) : super(key: key);
  NearByFutaslDataListModel model1;

  @override
  State<MapBooKAMatchScreen> createState() => _MapBooKAMatchScreenState();
}

class _MapBooKAMatchScreenState extends State<MapBooKAMatchScreen> {
