// ignore_for_file: prefer_const_constructors, must_be_immutable, sized_box_for_whitespace, sort_child_properties_last, unused_field
...
import 'package:futsal/view/screen/map_screen/components/map_book_a%20match_screen.dart';
import 'package:futsal/view/screen/map_screen/components/map_report_screen.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:provider/provider.dart';

class MapSinglePage extends StatefulWidget {
  MapSinglePage({Key? key, required this.model1}) : super(key: key);
  NearByFutaslDataListModel model1;

  @override
  State<MapSinglePage> createState() => _MapSinglePageState();
}

class _MapSinglePageState extends State<MapSinglePage> {
  String? _chosenValue;
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //report this futsal
                      MapReportsWidget(model1: widget.model1)
          ...
          builder: (context, value, child) => FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => 
                      MapBooKAMatchScreen(model1: widget.model1)
                   ));
