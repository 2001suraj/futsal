...
import 'package:futsal/view/screen/home_screen/components/home_slider/components/book_screen.dart';
import 'package:futsal/view/screen/home_screen/components/home_slider/components/custome_btn_row.dart';
import 'package:provider/provider.dart';
import 'package:table_calendar/table_calendar.dart';

class BooKAMatchScreen extends StatefulWidget {
  BooKAMatchScreen({Key? key, required this.model1}) : super(key: key);
  FutsalSliderModel1 model1;



  @override
  State<BooKAMatchScreen> createState() => _BooKAMatchScreenState();
}

class _BooKAMatchScreenState extends State<BooKAMatchScreen> {
