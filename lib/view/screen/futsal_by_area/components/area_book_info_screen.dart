...
class AreaBookingInfoScreen extends StatefulWidget {
  ...
  @override
  State<AreaBookingInfoScreen> createState() => _BookingInfoScreenState();
}

class _BookingInfoScreenState extends State<AreaBookingInfoScreen> {
  // ESewaPnp? _esewaPnp;
