...
import 'package:futsal/view/screen/futsal_by_area/components/area_book_a_match.dart';
import 'package:futsal/view/screen/futsal_by_area/components/area_report_widget.dart';
...
class AreaSingelHomeSliderPage extends StatefulWidget {
  AreaSingelHomeSliderPage({Key? key, required this.model1 }) : super(key: key);
  FutsalByAreadataModel model1;

  @override
  State<AreaSingelHomeSliderPage> createState() => _SingelHomeSliderPageState();
}

class _SingelHomeSliderPageState extends State<AreaSingelHomeSliderPage> {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AreaReportsWidget(model1: widget.model1),
                    ],
                  ),
                ),
                SizedBox(
          ...
          builder: (context, value, child) => FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => AreaBooKAMatchScreen(
