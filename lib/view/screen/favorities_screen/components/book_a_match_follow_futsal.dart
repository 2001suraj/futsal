...
import 'package:futsal/view/screen/favorities_screen/components/book_info_screen_follow_futsal.dart';

import 'package:futsal/view/screen/home_screen/components/home_slider/components/custome_btn_row.dart';
import 'package:provider/provider.dart';
import 'package:table_calendar/table_calendar.dart';

class BooKAMatchFollowFutsalScreen extends StatefulWidget {
  BooKAMatchFollowFutsalScreen({Key? key, required this.model1})
      : super(key: key);
  FollowedFutsalListDataModel model1;

  @override
  State<BooKAMatchFollowFutsalScreen> createState() =>
      _BooKAMatchFollowFutsalScreenState();
}

class _BooKAMatchFollowFutsalScreenState
    extends State<BooKAMatchFollowFutsalScreen> {
